...
//     const uni = req.query.code;
    
//     var resposne = [];
//     var GetUni = MajorUpdate.findOne({"uni": uni}).then(
//         university => {
//             var major = MajorUpdate.find().then(
//                 result => {
...
//                            continue;
//                        }
//                        for (j = 0 ; j < result[i].mjs.length; j ++) {
//                            for(k = 0; k < university.mjs.length; k ++){
...
//                     resposne = resposne.splice(0,5);
//                     return send.success(res, "Recommender Successful", resposne);
//                 }
//             )
//         }
//     )
